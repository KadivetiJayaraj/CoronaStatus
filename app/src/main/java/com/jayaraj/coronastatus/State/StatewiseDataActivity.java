package com.jayaraj.coronastatus.State;
...
import com.jayaraj.coronastatus.IndividualData.PerStateData;
...
public class StatewiseDataActivity extends AppCompatActivity
    implements StatewiseAdapter.OnItemClickListner {
    ...
    swipeRefreshLayout.setOnRefreshListener(
        new SwipeRefreshLayout.OnRefreshListener() {
          ...
          public void onRefresh() {
            ...
            Toast.makeText(StatewiseDataActivity.this, "Data refreshed!", Toast.LENGTH_SHORT)
                .show();
          }
        });
                    ...
                    Runnable progressRunnable =
                        new Runnable() {
                          ...
                          public void run() {
                            ...
                            statewiseAdapter =
                                new StatewiseAdapter(
                                    StatewiseDataActivity.this, statewiseModelArrayList);
        ...
        new Runnable() {
          ...
          public void run() {
            if (confirmation != 1) {
              progressDialog.cancel();
              Toast.makeText(
                      StatewiseDataActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT)
                  .show();
            }
          }
        };
