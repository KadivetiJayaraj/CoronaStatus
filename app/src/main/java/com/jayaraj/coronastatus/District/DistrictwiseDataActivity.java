package com.jayaraj.coronastatus.District;
...
import com.jayaraj.coronastatus.IndividualData.PerDistrictData;
    ...
    swipeRefreshLayout.setOnRefreshListener(
        new SwipeRefreshLayout.OnRefreshListener() {
          ...
          public void onRefresh() {
            ...
            Toast.makeText(DistrictwiseDataActivity.this, "Data refreshed!", Toast.LENGTH_SHORT)
                .show();
          }
        });
              ...
              public void onResponse(JSONArray jsonArray) {
                try {
                  ...
                  for (int i = 1; i < jsonArray.length(); i++) {
                    ...
                    if (stateName
                        .toLowerCase()
                        .equals(jsonObject.getString("state").toLowerCase())) {
                      ...
                      for (int j = 0; j < jsonArray2.length(); j++) {
                        ...
                        districtModelArrayList.add(
                            new DistrictModel(
                                ...
                                districtRecovered,
                                districtDeceased,
                                districtNewConfirmed,
                                districtNewRecovered,
                                districtNewDeceased));
                        ...
                        Collections.sort(
                            districtModelArrayList,
                            new Comparator<DistrictModel>() {
                              @Override
                              public int compare(DistrictModel o1, DistrictModel o2) {
                                if (Integer.parseInt(o1.getConfirmed())
                                    > Integer.parseInt(o2.getConfirmed())) {
                                  return -1;
                                } else {
                                  return 1;
                                }
                  ...
                  Runnable progressRunnable =
                      new Runnable() {
                        ...
                        public void run() {
                          ...
                          districtAdapter =
                              new DistrictAdapter(
                                  DistrictwiseDataActivity.this, districtModelArrayList);
        ...
        new Runnable() {
          ...
          public void run() {
            if (confirmation != 1) {
              progressDialog.cancel();
              Toast.makeText(
                      DistrictwiseDataActivity.this,
                      "Internet slow/not available",
                      Toast.LENGTH_SHORT)
                  .show();
            }
          }
