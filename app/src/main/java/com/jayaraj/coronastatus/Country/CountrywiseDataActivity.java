package com.jayaraj.coronastatus.Country;
...
import com.jayaraj.coronastatus.IndividualData.PerCountryData;
    ...
    swipeRefreshLayout.setOnRefreshListener(
        new SwipeRefreshLayout.OnRefreshListener() {
          ...
          public void onRefresh() {
            ...
            Toast.makeText(CountrywiseDataActivity.this, "Data refreshed!", Toast.LENGTH_SHORT)
                .show();
          }
        });
              ...
              public void onResponse(JSONArray response) {
                ...
                try {
                  ...
                  for (int i = 0; i < response.length(); i++) {
                    ...
                    Collections.sort(
                        countrywiseModelArrayList,
                        new Comparator<CountrywiseModel>() {
                          @Override
                    ...
                    Runnable progressRunnable =
                        new Runnable() {
                          ...
                          public void run() {
                            ...
                            countrywiseAdapter =
                                new CountrywiseAdapter(
                                    CountrywiseDataActivity.this, countrywiseModelArrayList);
