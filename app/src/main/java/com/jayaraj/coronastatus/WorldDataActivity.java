...
import com.jayaraj.coronastatus.Country.CountrywiseDataActivity;
...
public class WorldDataActivity extends AppCompatActivity {
  ...
  TextView textView_confirmed,
      ...
      textView_totalActive,
      textView_totalRecovered,
      textView_totalRecovered_new,
      textView_death,
      textView_death_new,
      textView_tests;
                        ...
                        new Runnable() {
                          ...
                          public void run() {
                            ...
                            mPieChart.addPieSlice(
                                new PieModel(
                                    "Active",
                                    Integer.parseInt(totalActiveCopy),
                                    Color.parseColor("#007afe")));
                            mPieChart.addPieSlice(
                                new PieModel(
                                    "Recovered",
                                    Integer.parseInt(totalRecoveredCopy),
                                    Color.parseColor("#08a045")));
                            mPieChart.addPieSlice(
                                new PieModel(
                                    "Deceased",
                                    Integer.parseInt(totalDeceasedCopy),
                      ...
                      Runnable progressRunnable =
                          new Runnable() {
                            ...
                            public void run() {
                              ...
                              int totalRecoveredNewInt = Integer.parseInt(newRecovered);
                              newRecovered =
                                  NumberFormat.getInstance().format(totalRecoveredNewInt);
                              textView_totalRecovered_new.setText("+" + newRecovered);
        ...
        new Runnable() {
          ...
          public void run() {
            if (confirmation != 1) {
              progressDialog.cancel();
              Toast.makeText(
                      WorldDataActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT)
                  .show();
            }
          }
        };
