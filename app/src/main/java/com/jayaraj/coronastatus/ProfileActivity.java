          ...
          public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (id) {
              case R.id.news:
                ...
                break;
              case R.id.safety:
                startActivity(new Intent(ProfileActivity.this, SafetyActivity.class));
                break;
              case R.id.settings:
                startActivity(new Intent(ProfileActivity.this, SampleActivity.class));
                break;
              case R.id.logout:
        ...
        new Runnable() {
          ...
          public void run() {
            if (confirmation != 1) {
              progressDialog.cancel();
              Toast.makeText(
                      ProfileActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT)
                  .show();
            }
          }
        };
