package com.jayaraj.coronastatus.IndividualData;
...
import com.jayaraj.coronastatus.District.DistrictwiseDataActivity;
import com.jayaraj.coronastatus.ProfileActivity;
import com.jayaraj.coronastatus.R;
...
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_ACTIVE;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_CONFIRMED;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_DECEASED;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_LAST_UPDATE;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_NAME;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_NEW_CONFIRMED;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_NEW_DECEASED;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_NEW_RECOVERED;
import static com.jayaraj.coronastatus.State.StatewiseDataActivity.STATE_RECOVERED;

public class PerStateData extends AppCompatActivity {

  TextView perStateConfirmed,
      perStateActive,
      perStateDeceased,
      perStateNewConfirmed,
      perStateNewRecovered,
      perStateNewDeceased,
      perStateUpdate,
      perStateRecovered,
      perstateName;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mPieChart.addPieSlice(
        new PieModel("Active", Integer.parseInt(activeCopy), Color.parseColor("#007afe")));
    mPieChart.addPieSlice(
        new PieModel("Recovered", Integer.parseInt(recoveredCopy), Color.parseColor("#08a045")));
    mPieChart.addPieSlice(
        new PieModel("Deceased", Integer.parseInt(deceasedCopy), Color.parseColor("#F6404F")));
