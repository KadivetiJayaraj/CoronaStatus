...
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_ACTIVE;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_CONFIRMED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_DECEASED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_NAME;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_NEW_CONFIRMED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_NEW_DECEASED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_NEW_RECOVERED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_RECOVERED;
import static com.jayaraj.coronastatus.Country.CountrywiseDataActivity.COUNTRY_TESTS;

public class PerCountryData extends AppCompatActivity {
  TextView perCountryConfirmed,
      perCountryActive,
      perCountryDeceased,
      perCountryNewConfirmed,
      perCountryTests,
      perCountryNewDeceased,
      perCountryRecovered,
      perCountryNewRecovered;
  PieChart mPieChart;
