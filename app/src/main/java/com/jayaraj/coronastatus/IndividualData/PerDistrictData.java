...
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_ACTIVE;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_CONFIRMED;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_DECEASED;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_NAME;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_NEW_CONFIRMED;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_NEW_DECEASED;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_NEW_RECOVERED;
import static com.jayaraj.coronastatus.District.DistrictwiseDataActivity.DISTRICT_RECOVERED;

public class PerDistrictData extends AppCompatActivity {

  TextView perDistrictConfirmed,
      perDistrictActive,
      perDistrictDeceased,
      perDistrictNewConfirmed,
      perDistrictNewRecovered,
      perDistrictNewDeceased,
      perDistrictUpdate,
      perDistrictRecovered,
      perDistrictName;
  PieChart mPieChart;
  String districtName;
